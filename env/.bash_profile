...
then
    ...
    export FIREWORK_HOME="$HOME/hulu/firework-0.2.0/"
    export ECLIPSE_HOME="/Applications/Eclipse.app/Contents/Eclipse"
    export VIRTUALENVWRAPPER_PYTHON="$HOME/miniconda2/bin/python2.7"
else
    export VIRTUALENVWRAPPER_PYTHON="/usr/bin/python2.7"
fi

export PYTHONPATH="$HOME/Library/Python/2.7/lib/python/site-packages/:/Library/Python/2.7/site-packages/"
export PS1="> "
